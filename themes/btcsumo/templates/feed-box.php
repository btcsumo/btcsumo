    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">
          ...
          <a href="<?= $twitter_url; ?>" target="_blank" class="feed-twitter fa fa-twitter" title="<?php _e( 'Twitter', 'btcsumo' ); ?>"></a>
          <?php endif; ?>
          <a href="<?= $site_url; ?>" target="_blank"><?php the_title(); ?></a>
          <span class="feed-refresh fa fa-refresh" title="<?php _e( 'Refresh', 'btcsumo' ); ?>"></span>
        </h3>
      </div>
